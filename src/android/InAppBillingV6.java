...
//			iabHelper.launchSubscriptionPurchaseFlow(cordovaActivity, sku, newOrder, oipfl, "", extraParams);
			iabHelper.launchSubscriptionPurchaseFlow(cordovaActivity, sku, newOrder, oipfl, "", Bundle.EMPTY);
		} else {
//			iabHelper.launchPurchaseFlow(cordovaActivity, sku, newOrder, oipfl, "", extraParams);
			iabHelper.launchPurchaseFlow(cordovaActivity, sku, newOrder, oipfl, "", Bundle.EMPTY);
